...
const es = {
  ...
  producto: {
    ...
    // Lámina "Conecta sin límites" (cables y adaptadores especiales).
    solutions: {
      eyebrow: "Cables y adaptadores especiales",
      headingTop: "Conecta sin límites.",
      headingBottom: "Diagnostica todo.",
      p1: "Amplía las capacidades de tu Jaltest con nuestra selección de",
      p1Strong: "cables y adaptadores especializados.",
      p2: "Diseñados para ofrecer compatibilidad con una mayor variedad de marcas, modelos y sistemas que no están incluidos en el kit estándar.",
      hexBadgeTop: "Equipa tu taller",
      hexBadgeBottom: "con todo lo que necesitas",
      hexAlt: "Cables y adaptadores especiales Jaltest",
      features: [
        { title: "Compatibilidad extendida", desc: "Cubre sistemas y equipos fuera del kit estándar." },
        { title: "Calidad garantizada", desc: "Cables y adaptadores originales diseñados para máxima confiabilidad y durabilidad." },
        { title: "Conexión precisa", desc: "Comunicación estable y segura para diagnósticos exactos en cada intervención." },
        { title: "Imprescindibles para profesionales", desc: "La herramienta correcta para cada vehículo y cada tarea." },
      ],
      ctaTitle: "No dejes ningún equipo sin diagnosticar",
      ctaBody: "Encuentra el cable o adaptador que necesitas y lleva tu Jaltest al siguiente nivel.",
      ctaLink: "Ver cables y adaptadores",
      ctaLinkSub: "Disponibles",
    },
    renew: {
...
const en: Dict = {
  ...
  producto: {
    ...
    solutions: {
      eyebrow: "Special cables and adapters",
      headingTop: "Connect without limits.",
      headingBottom: "Diagnose everything.",
      p1: "Expand your Jaltest capabilities with our selection of",
      p1Strong: "specialized cables and adapters.",
      p2: "Designed to deliver compatibility with a wider range of brands, models and systems that are not included in the standard kit.",
      hexBadgeTop: "Equip your shop",
      hexBadgeBottom: "with everything you need",
      hexAlt: "Jaltest special cables and adapters",
      features: [
        { title: "Extended compatibility", desc: "Covers systems and equipment outside the standard kit." },
        { title: "Guaranteed quality", desc: "Original cables and adapters built for maximum reliability and durability." },
        { title: "Precise connection", desc: "Stable, secure communication for accurate diagnostics every time." },
        { title: "Essential for professionals", desc: "The right tool for every vehicle and every job." },
      ],
      ctaTitle: "Don't leave any equipment undiagnosed",
      ctaBody: "Find the cable or adapter you need and take your Jaltest to the next level.",
      ctaLink: "See cables and adapters",
      ctaLinkSub: "Available",
    },
    renew: {
